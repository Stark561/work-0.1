/*! mailcheck v1.1.2 @licence MIT */ var Mailcheck = {
  ...
  defaultSecondLevelDomains: [
    ...
    "icloud",
    "rambler",
    // Другие популярные второстепенные домены...
  ],
  defaultTopLevelDomains: [
    ...
    "eu",
    "se",
    // Другие распространенные доменные зоны верхнего уровня...
  ],  
  run: function (a) {
  ...
  sift3Distance: function (a, b) {
    if (null == a || 0 === a.length)
      return null == b || 0 === b.length ? 0 : b.length;
    if (null == b || 0 === b.length) return a.length;
    for (
      var c = 0, d = 0, e = 0, f = 0, g = 5;
      c + d < a.length && c + e < b.length;
